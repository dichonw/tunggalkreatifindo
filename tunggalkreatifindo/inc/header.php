    ...
    <nav class="navbar navbar-expand-lg fixed-top" >
      <div class="container-fluid">
        <a class="navbar-brand" href="?menu=home">
          <img src="img/tk.png" width="50" alt="">
        </a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"><i class="fa fa-navicon" style="color:#5087D9"></i></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="">
          <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link"  href="?menu=home">Jasa Kami</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"  href="?menu=home">Event</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"  href="?menu=home">KlikPoin</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"  href="?menu=home">Profil</a>
            </li>
          </ul>
        </div>
      </div>
